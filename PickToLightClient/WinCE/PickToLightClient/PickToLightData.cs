...
namespace SNA.Mobile.PickToLightClient
{
    public class PickToLightData
    {
        ...
        //public static int CreateLogEntry(string Source, string ThreadName, int ThreadID, string Data)
        //public int CreateLogEntry(LogSQL logSQL)
        ...
        //public static int CreateScanManifestEntry(ManifestSQL manifest)
        ...
        //public static int CreateToyotaOWKScanEntry(ToyotaOWKSQL toyotaOWK)
        ...
        //public static int CreateScanInternalKanbanEntry(InternalKanbanSQL internalKanban)
        ...
        //public static int CreateScanUnKnownEntry(string barcode, string expectedScanType, string scanType, string deviceName, string deviceIdentifier, string scannedBy, string createdBy)
        //public int CreateScanUnKnownEntry(ScanUnKnownSQL scanUnKnown)
    ...
    public class ManifestSQL
    {
        ...
        //private IDictionary<string, int> _KanbansScanned;
        //public IDictionary<string, int> KanbansScanned { get { return _KanbansScanned; } private set {_KanbansScanned = value;} } //The publicly exposed property, with a private setter so nobody can change the actual Dictionary itself (KanbansScanned). This requires the Dictionary to be created in the Constructor.
        ...
        {
            //_KanbansScanned = new Dictionary<string, int>();
        ...
        {
            //if (_KanbansScanned.ContainsKey(kanban))
            //{
            //    int value = int.Parse("0");
            //    //int currentValue = int.Parse(_KanbansScanned[kanban]);
            //    int currentValue = _KanbansScanned[kanban];
            //    _KanbansScanned[kanban] = currentValue + 1;
            //}
            //else
            //{
            //    _KanbansScanned.Add(kanban, 1);
            //}
        ...
        //public void Copy(ManifestSQL source)
        //{
        //    this.Barcode = source.Barcode;
        //    this.OrderNumber = source.OrderNumber;
        //    this.NAMC = source.NAMC;
    ...
    //public class ScanUnKnownSQL
    //{
    //    public string Barcode { get; set; }
    //    public string ExpectedScanType { get; set; }
